...
export default function TournamentPage() {
  ...
  // Tournament slugs from Liquipedia often contain a "/" (e.g. "MSC/2026"),
  // so this route is a catch-all — params.slug arrives as an array of path
  // segments that we rejoin into the real slug.
